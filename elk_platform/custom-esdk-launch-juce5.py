...
try:
    ...
    cd {}; 
    . {};
    cd /code/source/elk_platform/SourceSamplerJUCE5Build/Builds/ELKAudioOS
    ...
    AR=aarch64-elk-linux-ar make -j2 CONFIG=Debug CFLAGS="-DJUCE_HEADLESS_PLUGIN_CLIENT=1 -DELK_BUILD=1 -Wno-psabi" TARGET_ARCH="-mcpu=cortex-a72 -mtune=cortex-a72" -i
