...
try:
    ...
    cd {}; 
    . {};
    cd /code/source/elk_platform/ttymidi/mod-ttymidi
    ...
    AR=aarch64-elk-linux-ar make -j2 CONFIG=Release CFLAGS="-Wno-psabi" TARGET_ARCH="-mcpu=cortex-a72 -mtune=cortex-a72" -i
